# Playtesting checklist, EMI Refreshed
...
* [ ] The viewer opens and lists items
* [ ] Search, favourites and the recipe tree all work
* [ ] Recipes from other mods show, including ones added through its api
* [ ] Nothing is missing from the index, and nothing is listed twice
* [ ] No stack throws while the index bakes, which shows in the log as a hidden stack
...
* [ ] Works with anything that hooks into its plugin api
